      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-balance mb-6">
            Growth <span className="text-accent">Engine</span>
          </h1>
          
          <p className="text-xl text-muted-foreground text-balance mb-8 max-w-2xl mx-auto leading-relaxed">
            Accelerate your startup's growth with AI-powered marketing strategies, growth hacking techniques, 
          ...
          <div className="bg-card/50 border border-border rounded-2xl p-8 mb-8 max-w-2xl mx-auto">
            ...
            <ul className="text-left space-y-3 text-muted-foreground">
              <li className="flex items-start space-x-2">
                ...
                <span>AI-powered growth strategy recommendations</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0"></div>
                <span>Automated marketing campaign generation</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0"></div>
                <span>Customer acquisition cost optimization</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0"></div>
                <span>A/B testing and conversion optimization</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0"></div>
                <span>Growth metrics tracking and analytics</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0"></div>
                <span>Viral growth tactics and referral systems</span>
              </li>
            </ul>
          </div>
          ...
          <p className="text-sm text-muted-foreground mt-6">
            Expected launch: Q3 2025 • Be among the first to know when it's ready
          </p>
        </div>
      </section>
