      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-balance mb-6">
            Founder <span className="text-accent">Network</span>
          </h1>
          
          <p className="text-xl text-muted-foreground text-balance mb-8 max-w-2xl mx-auto leading-relaxed">
            Connect with co-founders, advisors, and mentors. Build meaningful relationships that will help 
            you grow your startup and achieve success.
          </p>
          ...
          <div className="bg-card/50 border border-border rounded-2xl p-8 mb-8 max-w-2xl mx-auto">
            ...
            <ul className="text-left space-y-3 text-muted-foreground">
              <li className="flex items-start space-x-2">
                ...
                <span>AI-powered matching with compatible co-founders and mentors</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0"></div>
                <span>Industry-specific founder groups and communities</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0"></div>
                <span>Virtual and local networking events</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0"></div>
                <span>Skill-based collaboration opportunities</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0"></div>
                <span>Mentor matching based on your startup's needs</span>
              </li>
            </ul>
          </div>
          ...
          <p className="text-sm text-muted-foreground mt-6">
            Expected launch: Q2 2025 • Be among the first to know when it's ready
          </p>
        </div>
      </section>
